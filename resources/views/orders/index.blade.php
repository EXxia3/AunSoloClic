<x-app-layout>
    ...
    <div class="container py-12">
        ...
        <section class="grid grid-cols-5 gap-6 text-white">
            <a href="{{ route('orders.index') . "?status=1" }}" class=" bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{ route('orders.index') . "?status=2" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$recibido}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=3" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$enviado}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=4" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$entregado}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=5" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$anulado}}
                </p>
