<x-admin-layout>
    ...
    <div class="container  py-12">
        ...
        <section class="grid grid-cols-4 gap-6 text-white">
            ...
            <a href="{{ route('admin.orders.index') . "?status=2" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700  bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
            ...
            <a href="{{ route('admin.orders.index') . "?status=3" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700  bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$enviado}}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . "?status=4" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$entregado}}
                </p>
            ...
            <a href="{{ route('admin.orders.index') . "?status=5" }}" class="bg-gradient-to-r from-gray-800 to-indigo-700  bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{$anulado}}
                </p>
