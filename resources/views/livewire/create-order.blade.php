<div class="container py-8 grid lg:grid-cols-2 xl:grid-cols-5 gap-6">
    ...
    <div class="order-2 lg:order-1 lg:col-span-1 xl:col-span-3">
        ...
        <div x-data="{ envio_type: @entangle('envio_type') }">
            ...
            <label class="bg-white rounded-lg shadow px-6 py-4 flex items-center mb-4 cursor-pointer">
                ...
                <span class="ml-2 text-gray-700">
                    Paso a buscar en la tienda (Calle La Rioja 687)
                </span>
                ...
                <div class="px-6 pb-6 grid grid-cols-2 gap-6 hidden" :class="{ 'hidden': envio_type != 2 }">
                    ...
                    <div>
                        ...
                        <select class="form-control w-full" wire:model="district_id">
                            ...
                            <option value="" disabled selected>Seleccione tu Barrio</option>
                    ...
                    <div class="col-span-2">
                        <x-jet-label value="Referencia de domicilio" />
        ...
        <div>
            ...
            <p class="text-sm text-gray-700 mt-2">Las marcas y logos de aunsoloclic son propiedad de La Escuela Técnica Carmen Molina de Llano los derechos reservados 2022
                <a href="https://www.facebook.com/EscuelaTecnicaLlano/" class="font-semibold text-indigo-500">Políticas y privacidad</a></p>
        </div>
