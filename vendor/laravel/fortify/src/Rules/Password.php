    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('La :attribute debe tener por lo menos :length caracteres y contener por lo menos una letra en Mayúscula.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __('La :attribute debe tener por lo menos :length caracteres y contener por lo menos un Número.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('La :attribute debe tener por lo menos :length caracteres y contener por lo menos una letra en Mayúscula y un número.', [
                    'length' => $this->length,
                ]);
            ...
            default:
                return __('La :attribute debe tener por lo menos :length de longitud.', [
                    'length' => $this->length,
                ]);
        }
    }
